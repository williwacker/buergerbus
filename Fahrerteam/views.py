...
def index(request):
	...
	return render(request, 'Fahrerteam/index.html', context)

def detail(request, id):
    details = get_object_or_404(Fahrer, pk=id)
    context = {'details':details}
    print(details)
    return render(request, 'Fahrerteam/detail.html', context)

def results(request, id):
	response = "You're looking at the results of Fahrerteam %s."
