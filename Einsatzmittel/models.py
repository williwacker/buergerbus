...
class Buero(models.Model):
	...
	buerotage  = models.CharField(choices=BUERO_TAGE_AUSWAHL, max_length=20, default='', verbose_name = "Bürotag")
...
class Bus(models.Model):
	...
	fahrtage    = models.CharField(choices=BUS_TAGE_AUSWAHL, max_length=20, default='Di,Do', verbose_name="Fahrtag")
	updated_on  = models.DateTimeField(auto_now=True, blank=True, null=True)
	updated_by  = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=models.SET_NULL)
