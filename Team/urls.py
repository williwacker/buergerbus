...
from .views import (FahrerAddView, FahrerChangeView, FahrerCopyView,
                    FahrerDeleteView, FahrerView, KoordinatorAddView,
                    KoordinatorChangeView, KoordinatorCopyView,
...
urlpatterns = [
    ...
    path('koordinator/<int:pk>/copy/', KoordinatorCopyView.as_view()),
