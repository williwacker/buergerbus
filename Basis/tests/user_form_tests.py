...
class UserChgFormTest(TestCase):
    ...
    def test_chg_form_is_staff_field_help_text(self):
        form = MyUserChangeForm()
        self.assertEqual(
            form.fields['is_staff'].help_text,
    ...
    def test_chg_form_is_superuser_field_help_text(self):
        form = MyUserChangeForm()
        self.assertEqual(
            form.fields['is_superuser'].help_text,
    ...
    def test_chg_form_password_field_help_text(self):
        ...
        self.assertEqual(
            ...
            'Die Passwörter werden nicht im Klartext gespeichert und können daher nicht dargestellt, sondern nur mit <a href="../password/">diesem Formular</a> geändert werden.')
