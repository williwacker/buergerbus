...
class TopicView(MyListView):
	...
	def get_context_data(self, **kwargs):
		...
		if self.request.user.is_superuser: context['add'] = "Thema"
...
class TopicAddView(MyCreateView):
	...
	def form_valid(self, form):
		...
		instance.save()
		self.success_message = self.model._meta.verbose_name_raw+' "<a href="'+self.success_url+str(instance.id)+'/'+url_args(self.request)+'">'+instance.name+'</a>" wurde erfolgreich hinzugefügt.'
