...
class KlientenSearchResultForm(forms.Form):
    suchergebnis = forms.ChoiceField(required=False, widget=forms.RadioSelect(), label="Suchergebnis")
    ...
    force_create = forms.BooleanField(
        required=False, label="Ähnlichkeit erlauben",
