...
class FahrgastTestCase(TestCase):
    ...
    def test_fahrgast_outside(self):
        ...
        try:
            d1 = Klienten.objects.create(name='Becker, Willi', telefon='06731-1111',
                                         mobil='0150-1111', ort=o1, strasse=s1, hausnr='25', typ='F')
    ...
    def test_fahrgast_non_outside_fail(self):
        ...
        with self.assertRaises(ValidationError) as cm:
            d2 = Klienten.objects.create(name='Schmitt, Horst', telefon='06731-222',
                                         mobil='', ort=o1, strasse=s2, hausnr='1', typ='F')
    ...
    def test_fahrgast_non_outside_success(self):
        ...
        try:
            d2 = Klienten.objects.create(name='Schmitt, Horst', telefon='06731-222',
                                         mobil='', ort=o2, strasse=s2, hausnr='1', typ='F')
        except:
            pass
