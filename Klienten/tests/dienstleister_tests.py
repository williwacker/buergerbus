...
class DienstleisterTestCase(TestCase):
	...
	def test_dienstleister_google(self):
		...
		d1 = Klienten.objects.create(name='Dr. Mabuse', telefon='06731-1111', mobil='0150-1111', ort=o1, strasse=s1, hausnr='25', typ='D')
	...
	def test_dienstleister_non_google(self):
		...
		d2 = Klienten.objects.create(name='Löwen Apotheke', telefon='06731-222', mobil='', ort=o1, strasse=s2, hausnr='1', typ='D')
