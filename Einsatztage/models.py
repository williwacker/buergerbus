...
class Fahrtag(models.Model):
    ...
    fahrer_vormittag = models.ForeignKey(Fahrer, null=True, blank=True, related_name="+",
                                         verbose_name='Fahrer Vormittag', on_delete=models.SET_NULL)
    fahrer_nachmittag = models.ForeignKey(Fahrer, null=True, blank=True, related_name="+",
                                          verbose_name='Fahrer Nachmittag', on_delete=models.SET_NULL)
